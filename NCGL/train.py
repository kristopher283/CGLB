...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str,
                        choices=["bare", 'lwf', 'gem', 'ewc', 'mas', 'twp', 'jointtrain', 'ergnn', 'joint', 'Joint', 'dce', 'sl', 'erlimit', 'erreplace', 'our'], default="gem",
    ...
    parser.add_argument('--erlimit_args', type=str2dict, default={'budget': [100], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--erreplace_args', type=str2dict, default={'budget': [100], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--dce_args', type=str2dict, default={'budget': [100], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--sl_args', type=str2dict, default={'budget': [100], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--our_args', type=str2dict, default={'budget': [100], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    ...
    method_args = {'ergnn': args.ergnn_args, 'lwf': args.lwf_args, 'twp': args.twp_args, 'ewc': args.ewc_args,
                   ...
                   'dce': args.dce_args, 'sl': args.sl_args, 'erlimit': args.erlimit_args, 'erreplace': args.erreplace_args, 'our': args.our_args}
