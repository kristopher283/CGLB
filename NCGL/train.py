...
if __name__ == '__main__':
    ...
    parser.add_argument('--ergnn_args', type=str2dict, default={'budget': [10, 100, 1000], 'd': [0.5], 'sampler': ['CM']},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--erreplace_args', type=str2dict, default={'budget': [20, 200, 2000], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--dce_args', type=str2dict, default={'budget': [20, 200, 2000], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--sl_args', type=str2dict, default={'budget': [20, 200, 2000], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--our_args', type=str2dict, default={'budget': [20, 200, 2000], 'd': [0.5], 'sampler': ['CM'], 'max_size': [0.5]},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
