...
class NET(torch.nn.Module):
    ...
    def __init__(self,
        ...
        # setup network
        self.net = model
        self.sampler = samplers[args.erlimit_args['sampler']]
        ...
        # so that we will have the memory_size <= max_size like other method
        self.budget = int(args.erlimit_args['budget'] * args.erlimit_args['max_size'])
        self.d_CM = args.erlimit_args['d'] # d for CM sampler of ERGNN
        self.aux_g = None
